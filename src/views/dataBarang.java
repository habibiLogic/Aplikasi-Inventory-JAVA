...
public class dataBarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lbTanggal.setBackground(new java.awt.Color(255, 255, 255));
        ...
        labelKodePart.setBackground(new java.awt.Color(255, 255, 255));
        ...
        labelNamaPart.setBackground(new java.awt.Color(255, 255, 255));
        ...
        labelKeterangan.setBackground(new java.awt.Color(255, 255, 255));
        ...
        labelQty.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from tb_barang where kode_part like '%"+txtCari.getText()+"%' "
