...
public class laporanBarangKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","ID BK","Pelanggan","Kode Barang","Nama Barang","Qty","Keterangan"};
    ...
    public void pencarian(String sql){
        Object[] Baris = {"No","Tanggal","ID BK","Gudang","Kode_Part","Nama_Part","Qty","Keterangan"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarangKeluar.setModel(tabmode);
