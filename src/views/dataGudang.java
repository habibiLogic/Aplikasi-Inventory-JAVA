...
public class dataGudang extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","Kode Pelanggan","Nama Pelanggan","Alamat","Keterangan"};
    ...
    public void pencarian(String sql){
        Object[] Baris = {"No","Tanggal","Kode_Gudang","Nama_Gudang","Alamat","Keterangan"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelGudang.setModel(tabmode);
    ...
    private void initComponents() {
        ...
        labelNama.setText("Data Pelanggan");
        ...
        labelKodeGudang.setForeground(new java.awt.Color(255, 255, 255));
        labelKodeGudang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelKodeGudang.setText("Kode Pelanggan");
        ...
        labelNamaGudang.setForeground(new java.awt.Color(255, 255, 255));
        labelNamaGudang.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelNamaGudang.setText("Nama Pelanggan");
