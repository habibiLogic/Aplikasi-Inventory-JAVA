...
public class transaksiBarangKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","ID Detail BK","ID BK","Pelanggan","Kode Barang","Nama Barang","Qty","Keterangan"};
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
       try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet result=stat.executeQuery ("select * from  tb_detail_brg_keluar where "
                + "id_bk='" +txtIdBarangKeluar.getText()+"'");
            if (result.next()) {
                if (txtIdBarangKeluar.getText().equals(result.getString("id_bk"))){
                    //new menuUtama().show();
